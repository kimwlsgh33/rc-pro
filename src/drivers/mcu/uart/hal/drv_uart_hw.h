...
#define UART_UCSRB_UDRIE (1 << UDRIE0) // Data Register Empty Interrupt Enable
...
#define UART_UCSRB_RXC   (1 << RXC0)   // Receive Complete
#define UART_UCSRB_TXC   (1 << TXC0)   // Transmit Complete
#define UART_UCSRB_UDRE  (1 << UDRE0)  // Data Register Empty
